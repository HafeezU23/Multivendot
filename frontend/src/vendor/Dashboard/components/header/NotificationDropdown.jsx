...
export default function NotificationDropdown() {
  ...
  return <div className="relative">
      ...
      <Dropdown isOpen={isOpen} onClose={closeDropdown} className="absolute -left-[30px] sm:left-auto sm:right-0 mt-[17px] flex h-[480px] w-[300px] sm:w-[361px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark">
        ...
        <ul className="flex flex-col flex-1 overflow-y-auto custom-scrollbar pr-1 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-200 [&::-webkit-scrollbar-thumb]:rounded-full dark:[&::-webkit-scrollbar-thumb]:bg-gray-700">
