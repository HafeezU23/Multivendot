                                ...
                                <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-5 py-3.5 rounded-2xl border border-gray-200 focus:bg-white outline-none transition-all placeholder:text-gray-400 font-medium"
                                        />
                                    </div> 
                                ...
                                <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            type="email"
                                            placeholder="Enter your email"
                                            className="w-full px-5 py-3.5 rounded-2xl border border-gray-200 outline-none transition-all placeholder:text-gray-400 font-medium"
                                        />
                                    </div>
