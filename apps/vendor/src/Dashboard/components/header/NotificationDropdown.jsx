...
export default function NotificationDropdown() {
  ...
  return <div className="relative">
      ...
      <Dropdown isOpen={isOpen} onClose={closeDropdown} className="fixed left-1/2 top-[70px] -translate-x-1/2 sm:absolute sm:left-auto sm:-translate-x-0 sm:right-0 sm:top-auto sm:mt-[17px] flex h-[480px] w-[90vw] sm:w-[361px] max-w-[361px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark z-[99999]">
